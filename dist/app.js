...
(function ($) {
  $(document).ready(function () {
    ...
    $('#erase-filters').live('click', function () {
      ...
      $('.home-butorforgalmazas-grid-container').css('display', 'inline-block'); //$('.home-butorforgalmazas-slider').slick('slickRemove',null,null,true);
    ...
    $('.filter-element').live('click', function () {
      ...
      $.ajax({
        ...
        success: function success(results) {
          ...
          $('.home-butorforgalmazas-grid').html('');
          $('.home-butorforgalmazas-grid').html(results.content); //console.log($('.home-butorforgalmazas-slider').height());
    ...
    if ($('.filters-search').find('.search_bar').length) {
      var filters_search_bar = $('.filters-search').find('.search_bar'); //console.log(filters_search_bar.height());
    ...
    $('.filters-search').find('input[name=search_bar]').live('keyup', function (e) {
      ...
      if (KeyCode === 27) {
        ...
        $.ajax({
          ...
          success: function success(results) {
            results = $.parseJSON(results); //console.log(results.content);
    ...
    $('.ret_bar_link').live('click', function () {
      ...
      var Height = $('.home-butorforgalmazas-grid').height(); //$('.home-butorforgalmazas-slider-container').height(Height);
      ...
      $('.home-butorforgalmazas-grid-container').css('display', 'inline-block'); //$('.home-butorforgalmazas-slider').slideUp("slow");
      //$('.home-butorforgalmazas-slider').slick('slickRemove',null,null,true);
